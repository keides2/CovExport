...
# -*- coding: utf-8 -*-
#
# Usage: $ Python3 cov-connect2.py <Username> <Password> <"URL of Project">  # don't forget ""
# e.g.
# $ python3 cov-connect2.py shimatani xxxx "http://172.16.72.42:8080/reports.htm#v10166/p10025/fileInstanceId=2867033&defectInstanceId=23898696&mergedDefectId=199751"
# → https://172.16.72.42:8080/reports.htm#v10551/p10028　に変更する
...
def main():
    ...
    if (len(args) != 4):
        print("")
        print("    Usage: $ python3 " + args[0] + " username" + " password" + " \"URL of Project\"" + "  # don't forget \"\"")
        print("")
        quit()
    ...
    #   netloc='172.16.72.42:8080',
    #   path='/reports.htm',
    #   params='',
    #   query='',
    #   fragment='v10551/p10014')
    ...
    # フラグメント抽出
    fg = urllib.parse.urlparse(URL).fragment
    print("fragment: {}\n".format(fg))
    
    list = fg.split("/")                        # v10166, p10025, fileInstanceId
...
### ここに挿入
    # table2.json から fileInstanceId と defectInstanceId をき出す
    source = 'table2.json'
    ...
    if \
    ('"cid":' in line) or \
    ('lastDefectInstanceId' in line) or \
    ('fileInstanceId' in line)]
